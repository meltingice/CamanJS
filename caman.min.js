...
img=document.createElement("img"),imageReady=function(loaded_canvas){var args=arguments.length,canvas_id=!args?options.canvas:arguments[0],canvas=loaded_canvas||null,that=this;if(!canvas){if(!args&&canvas_id.substr(0,1)==="#"){canvas=document.getElementById(canvas_id.substr(1));if(!canvas){return;}}else{return Caman.store[canvas_id];}}
