...
return new CamanInstance(arguments,CamanInstance.Type.Canvas);}};Caman.version={release:"3.0",date:"1/2/12"};CamanInstance=(function(){CamanInstance.Type={Image:1,Canvas:2};function CamanInstance(args,type){if(type==null)type=CamanInstance.Type.Canvas;this.pixelStack=[];this.layerStack=[];this.renderQueue=[];switch(type){case CamanInstance.Type.Image:this.loadImage.apply(this,args);break;case CamanInstance.Type.Canvas:this.loadCanvas.apply(this,args);}}
...
return{r:this.c.pixelData[newLoc],g:this.c.pixelData[newLoc+1],b:this.c.pixelData[newLoc+2],a:this.c.pixelData[newLoc+3]};};return PixelInfo;})();RenderJob=(function(){RenderJob.Blocks=4;RenderJob.execute=function(instance,job,callback){var rj;rj=new RenderJob(instance,job,callback);switch(job.type){case Filter.Type.Plugin:return rj.executePlugin();default:return rj.executeFilter();}};function RenderJob(c,job,renderDone){this.c=c;this.job=job;this.renderDone=renderDone;}
...
val.r=(val.r/divisor)+bias;val.g=(val.g/divisor)+bias;val.b=(val.b/divisor)+bias;return val;};return RenderJob;})();Store=(function(){function Store(){}
